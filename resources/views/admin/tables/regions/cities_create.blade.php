...
@section('button_form')
    ...
    <button type="submit" form="cities_create" class="btn btn-success" xmlns:v-bind="http://www.w3.org/1999/xhtml">Сохранить</button>

@endsection

@section('content')

        <form id="cities_create" action="{{ route('admin.cities.store') }}" method="POST">
